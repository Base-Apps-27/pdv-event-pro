          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="hidden lg:flex items-center gap-2">
              <div className="flex items-center rounded-md border border-gray-300 shadow-sm bg-white">
                ...
                >
                  <a href={`${window.location.origin}/api/functions/serveSpeakerSubmissionV2?event_id=${eventId}`} target="_blank" rel="noopener noreferrer">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        onClick={async () => {
                          try {
                            const url = `${window.location.origin}/api/functions/serveSpeakerSubmissionV2?event_id=${eventId}`;
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  <DropdownMenuItem asChild>
                    <a href={`${window.location.origin}/api/functions/serveSpeakerSubmissionV2?event_id=${eventId}`} target="_blank" rel="noopener noreferrer" className="flex items-center w-full">
                      <LinkIcon className="w-4 h-4 mr-2" />
                      Abrir Formulario
                    </a>
                  </DropdownMenuItem>
