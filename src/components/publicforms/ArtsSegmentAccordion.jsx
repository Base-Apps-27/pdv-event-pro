...
export default function ArtsSegmentAccordion({ segment: initialSeg, submitterName, submitterEmail, isUnica }) {
    ...
    const handleSave = async () => {
        ...
        // CRITICAL: payload must be defined BEFORE any code references it.
        // BUG FIX (2026-02-28): Previously `payload` was referenced above its declaration,
        // causing a ReferenceError that silently crashed handleSave.
        // This was the root cause of "Hosanna" / "Can't Steal My Joy" / "Holy" save freezes.
        const payload = {
            segment_id: seg.id,
