  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      {showSuggestions && suggestions.length > 0 && (
        <div className="absolute z-50 w-full mt-1 border border-gray-300 rounded-md shadow-lg max-h-48 overflow-y-auto" style={{ backgroundColor: '#ffffff' }}>
          {suggestions.map((suggestion, index) => (
            <div
              ...
              style={{
                ...
                backgroundColor: index === selectedIndex ? '' : '#ffffff'
              }}
              onMouseDown={(e) => {
                e.preventDefault();
