export const es = {
  ...
  'users.roleBadge.Guest': 'Invitado',
  'users.roleBadge.Deactivated': 'Desactivado',
  'users.guest': 'Invitado - Acceso Temporal (Solo Mi Programa)',
  'users.deactivated': 'Desactivado - Sin Acceso',
  'users.deactivateGuests': 'Desactivar Invitados',
  'users.deactivateGuestsTitle': 'Desactivar Todos los Invitados',
  'users.deactivateGuestsDesc': 'Esto cambiará todos los usuarios Invitados a Desactivados, revocando su acceso. Ya no podrán iniciar sesión.',
  'users.deactivateGuestsConfirm': 'Sí, Desactivar Todos',
  'users.deactivateGuestsNone': 'No se encontraron usuarios Invitados activos',
  'users.guestsDeactivated': '{count} invitado(s) desactivado(s)',
  'users.expiresAt': 'Expira',
  'users.noExpiry': 'Sin expiración',
  'users.expired': 'Expirado',
  ...
  'speaker.addResource': 'Agregar recurso',
  'speaker.pasteUrl': 'Pega la URL aquí...',
  'common.add': 'Agregar',
  ...
  'feedback.title': 'Compartir Observación',
  'feedback.description': 'Captura observaciones e ideas para la planificación futura',
  'feedback.fabLabel': 'Compartir Observación',
  'feedback.session': 'Sesión',
  'feedback.selectSession': 'Seleccionar sesión...',
  'feedback.category': 'Categoría',
  'feedback.selectCategory': 'Seleccionar categoría...',
  'feedback.department': 'Departamento',
  'feedback.selectDepartment': 'Seleccionar departamento...',
  'feedback.yourFeedback': 'Tu Observación',
  'feedback.textPlaceholder': '¿Qué observaste? Ej. "Empezamos 3 minutos tarde y eso impactó en..."',
  ...
  'feedback.entries': 'entradas',
  'feedback.noFeedback': 'No hay entradas de retroalimentación aún',
  'feedback.allStatuses': 'Todos los Estados',
  'feedback.allCategories': 'Todas las Categorías',
  'feedback.allDepartments': 'Todos los Departamentos',
  'feedback.followUpPlaceholder': 'Agregar notas de seguimiento...',
  'feedback.cat.observation': 'Observación',
  'feedback.cat.improvement': 'Mejora',
  'feedback.cat.issue_encountered': 'Problema Encontrado',
  'feedback.cat.what_went_well': 'Lo Que Funcionó Bien',
  'feedback.cat.follow_up_needed': 'Seguimiento Necesario',
  'feedback.status.label': 'Estado',
  'feedback.status.pending': 'Pendiente',
  'feedback.status.reviewed': 'Revisado',
  'feedback.status.actioned': 'Gestionado',
  'feedback.status.dismissed': 'Descartado',

  // ── Push Notifications Admin (2026-03-17) ──
  'nav.pushNotifications': 'Notificaciones Push',
  'push.pageTitle': 'Notificaciones Push',
  'push.pageSubtitle': 'Rastrea, analiza y envía notificaciones push',
  'push.tabHistory': 'Historial',
  'push.tabHistoryShort': 'Historial',
  'push.tabAnalytics': 'Analíticas',
  'push.tabAnalyticsShort': 'Stats',
  'push.tabSend': 'Enviar Broadcast',
  'push.tabSendShort': 'Enviar',
  'push.loadError': 'Error al cargar datos de PushEngage',
  'push.noNotifications': 'No se han enviado notificaciones aún',
  'push.sent': 'Enviado',
  'push.viewed': 'Visto',
  'push.clicked': 'Clic',
  'push.failed': 'fallidos',
  'push.prev': 'Anterior',
  'push.next': 'Siguiente',
  'push.analyticsRange': 'Últimos 30 días',
  'push.newSubscribers': 'Nuevos Suscriptores',
  'push.unsubscribed': 'Desuscritos',
  'push.totalSent': 'Notificaciones Enviadas',
  'push.totalViews': 'Vistas Totales',
  'push.totalClicks': 'Clics Totales',
  'push.ctr': 'Tasa de Clics',
  'push.sendInfo': 'Broadcast a todos los suscriptores',
  'push.sendInfoDetail': 'Esta notificación se enviará a todos los suscriptores activos. No se admite deep linking — el contenido de la notificación es todo lo que el usuario verá.',
  'push.titleLabel': 'Título (máx 85 caracteres)',
  'push.titlePlaceholder': 'Ej. El servicio comienza en 15 min',
  'push.messageLabel': 'Mensaje (máx 135 caracteres)',
  'push.messagePlaceholder': 'Ej. Únete al culto dominical a las 9:30 AM...',
  'push.preview': 'Vista previa',
  'push.sendButton': 'Enviar Notificación',
  'push.confirmWarning': 'Esto enviará una notificación push a TODOS los suscriptores inmediatamente. Esta acción no se puede deshacer.',
  'push.confirmSend': 'Sí, Enviar Ahora',
  ...
  'dashboard.refreshCache': 'Actualizar Caché',
  'dashboard.refreshCache.refreshing': 'Actualizando...',
  'dashboard.refreshCache.success': 'Caché actualizado correctamente',
  'dashboard.refreshCache.error': 'Error al actualizar el caché',
