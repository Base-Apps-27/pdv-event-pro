...
| `@react-pdf/renderer` | Listed as active | **Not installed.** Not in `package.json`. No action needed. |
...
- [x] Remove `moment` from `package.json` (zero imports confirmed)
- [x] Remove `jspdf` from `package.json` (zero imports confirmed — all PDF uses `pdfmake`)
...
- ~~4.2 PDF library consolidation~~ → **DONE** (already unified on pdfmake)
...
|---|---|---|---|
| Phase 0 | 1–2 days | 1–2 days | Added jspdf removal (trivial) |
