...
import { Edit, Trash2, Music, MessageSquare, Languages, ListOrdered, Circle, Users, AlertTriangle, Bookmark, Clock, ChevronUp, ChevronDown, ArrowRightLeft, Copy } from "lucide-react";
                      ...
                      <ChevronDown className="w-4 h-4" />
                          ...
                          <div className="flex flex-col items-end justify-between gap-2 min-w-[80px]">
                            ...
                            <div className="flex gap-1">
                              ...
                              {canMove && (
                                <Button variant="outline" size="sm" onClick={() => setTransferState({ segment, mode: 'move' })} className="h-7 px-2" title={language === 'es' ? 'Mover / Copiar' : 'Move / Copy'}>
