  ...
  return (
    <div className="space-y-3 bg-pink-50 p-4 rounded border border-pink-200">
      ...
      <div className="border-t border-pink-200 pt-3 mt-3 space-y-2">
        <Label className="text-xs">{language === 'es' ? 'Guía de Artes' : 'Arts Directions'}</Label>
        <MultiFileOrLinkInput
          urls={formData.arts_run_of_show_url}
          onChange={(urls) => setFormData({ ...formData, arts_run_of_show_url: urls, arts_run_of_show_url_meta: null })}
