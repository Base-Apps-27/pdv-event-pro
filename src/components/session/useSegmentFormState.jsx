...
function buildFormData(segment, suggestedStartTime) {
  return {
    ...
    drama_handheld_mics: segment?.drama_handheld_mics ?? '',
    drama_headset_mics: segment?.drama_headset_mics ?? '',
    ...
    dance_handheld_mics: segment?.dance_handheld_mics ?? '',
    dance_headset_mics: segment?.dance_headset_mics ?? '',
