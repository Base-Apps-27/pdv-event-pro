...
export default function SegmentTimeline({ 
  ...
  return (
    <div className={`flex flex-col h-full bg-white/50 backdrop-blur-sm rounded-3xl border border-white/40 shadow-sm overflow-hidden ${className}`}>
      {/* Header */}
      <div className="bg-slate-800/5 p-4 border-b border-slate-200/50 flex items-center gap-2">
          ...
          return (
            <div 
              ...
              className={`
                ...
                ${index === 0 ? 'bg-white shadow-md border-l-4 border-pdv-teal scale-[1.02]' : 'bg-white/60 hover:bg-white border-l-4 border-transparent hover:border-slate-300'}
              `}
            >
              {/* Time */}
              <div className={`
