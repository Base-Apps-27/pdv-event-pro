      ...
      <CardContent className="space-y-6 pt-6">
        ...
        <div className="flex justify-end mb-4">
           <div className="flex gap-2">
             ...
             >
               <a href={`${window.location.origin}/api/functions/speakerFormV3?event_id=${event.id}`} target="_blank" rel="noopener noreferrer">
             ...
             <Button 
               ...
               onClick={async () => {
                  try {
                    const url = `${window.location.origin}/api/functions/speakerFormV3?event_id=${event.id}`;
