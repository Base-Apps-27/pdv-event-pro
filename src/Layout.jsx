  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gray-50">
        <Sidebar className="border-r border-gray-200 bg-pdv-charcoal">
          ...
          <SidebarContent className="p-3">
            <SidebarGroup>
              <SidebarGroupLabel className="text-xs font-bold text-gray-500 uppercase tracking-wider px-3 py-3">
                Navegación
              </SidebarGroupLabel>
              <SidebarGroupContent>
                <SidebarMenu>
                    ...
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton 
                        ...
                        className={`hover:bg-pdv-teal hover:text-white transition-all duration-200 rounded mb-1 ${
                          location.pathname === item.url ? 'gradient-pdv text-white font-semibold' : 'text-gray-300'
                        }`}
                      >
        ...
        <main className="flex-1 flex flex-col bg-gray-50">
          <header className="bg-white border-b border-gray-200 px-6 py-4 lg:hidden shadow-sm">
            <div className="flex items-center gap-4">
              <SidebarTrigger className="hover:bg-gray-100 p-2 rounded transition-colors duration-200 text-gray-700" />
              <h1 className="text-xl font-bold uppercase tracking-tight text-gray-900">EventoPro</h1>
            </div>
          </header>
